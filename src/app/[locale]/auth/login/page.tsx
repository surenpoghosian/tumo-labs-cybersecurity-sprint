      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-gray-900">{login("title")}</h1>
            <p className="text-gray-600">{login("subtitle")}</p>
          </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span>{login("signInWithGoogle")}</span>
                </Button>
                ...
                >
                  ...
                  <span>{login("signInWithGitHub")}</span>
                </Button>
              </div>
