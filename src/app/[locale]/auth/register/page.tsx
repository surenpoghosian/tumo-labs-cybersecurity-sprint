    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100">
      <div className="container mx-auto px-4 py-8">
        <Link href="/" className="inline-flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors mb-4">
          ...
          <span>{register("backToHome")}</span>
        </Link>

        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            <BookOpen className="h-12 w-12 text-orange-600 mx-auto mb-4" />
            <h1 className="text-2xl font-bold text-gray-900">{register("title")}</h1>
            <p className="text-gray-600">{register("subtitle")}</p>
          </div>

          <Card>
            <CardHeader>
              <CardTitle>{register("title")}</CardTitle>
              <CardDescription>{register("choose")}</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="truncate">{register("signUpWithGoogle")}</span>
                </Button>
                ...
                >
                  ...
                  <span className="truncate">{register("signUpWithGitHub")}</span>
                </Button>
              </div>
