      ...
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#process" className="text-gray-600 hover:text-blue-600">{homePage("process.title")}</a>
            <a href="#community" className="text-gray-600 hover:text-blue-600">Community</a>
            <Link href="/dashboard">
              <Button variant="outline">{navigation("dashboard")}</Button>
            </Link>
            <LocaleSwitcher />
          </nav>
        </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="block text-orange-600">{homePage("hero.title").split(" ").slice(-1)}</span>
          </h1>
          ...
          <div className="flex justify-center space-x-4">
            <Link href="/dashboard">
              <Button size="lg" className="bg-orange-600 hover:bg-orange-700">
                {homePage("hero.startTranslating")}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div>
              ...
              <div className="text-gray-600">{homePage("stats.docsTranslated")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-orange-600 mb-2">89</div>
              <div className="text-gray-600">{homePage("stats.translators")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-orange-600 mb-2">15</div>
              <div className="text-gray-600">{homePage("stats.projects")}</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-orange-600 mb-2">47</div>
              <div className="text-gray-600">{homePage("stats.pullRequests")}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-20 px-4">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
            {homePage("features.title")} CyberSec Docs?
          </h2>
